...
namespace BT
{
  public static class BaneExtenstions
  {
    ...
    public static Vector3 MidPoint(this Transform _pointA, Transform _pointB)
    {
      return (_pointA.position + _pointB.position) / 2;
    }
    ...
    public static Ray NewRay(this Transform _start, Vector3 _dir)
    {
      Ray _ray = new Ray(_start.position, _dir);
      return _ray;
    }
